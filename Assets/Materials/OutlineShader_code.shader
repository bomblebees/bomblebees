    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
            {
                ...
                float3 _RotateAboutAxis_5BABD68B_Out_3;
                Unity_Rotate_About_Axis_Degrees_float(IN.ObjectSpaceNormal, float3 (1, 0, 0), 180, _RotateAboutAxis_5BABD68B_Out_3);
                description.VertexPosition = _Add_C3CB088D_Out_2;
                description.VertexNormal = _RotateAboutAxis_5BABD68B_Out_3;
